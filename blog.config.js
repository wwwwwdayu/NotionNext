...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Dayu', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的城规🐕', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://notionnext-lilac.vercel.app/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '日常,分享', // 网站关键词 英文逗号隔开
